...
IOT_STATUS.STATUS_AIR = 0x200E;  //净化器开启
IOT_STATUS.STATUS_AIR_MODE = 0x200F;  //净化器手动模式
IOT_STATUS.STATUS_AIR_LOCK = 0x2010;   //净化器处于低压保护状态
IOT_STATUS.STATUS_AIR_SPEED1 = 0x2011;  //低速
IOT_STATUS.STATUS_AIR_SPEED2 = 0x2012;  //中速
IOT_STATUS.STATUS_AIR_SPEED3 = 0x2013;  //高速
